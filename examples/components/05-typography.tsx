    ...
    children: [
          ...
          Stack({
            ...
            children: [
              ...
              Stack({
                style: { padding: { top: 5 }, gap: 8 },
                children: [
                  Text({ style: { cpi: 17, condensed: true }, children: "17 CPI (Pica + Condensed)" }),
                  Text({ style: { cpi: 20, condensed: true }, children: "20 CPI (Elite + Condensed) - Most compact" }),
      ...
      Stack({
        ...
        children: [
          ...
          Text({ style: { cpi: 17, condensed: true }, children: "ABCDEFGHIJKLMNOPQRSTUVWXYZ (17 CPI)" }),
          Text({ style: { cpi: 20, condensed: true }, children: "ABCDEFGHIJKLMNOPQRSTUVWXYZ (20 CPI)" }),
        ],
      }),
