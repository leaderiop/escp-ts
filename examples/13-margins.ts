...
async function main() {
  ...
  const layout = stack()
    ...
    // Explanation
    .text('Margins add space OUTSIDE a node (between siblings).', { italic: true })
    .text('Padding adds space INSIDE a node (between border and content).', { italic: true })
    .spacer(20)
      ...
      stack()
        ...
        .add(
          stack()
            .margin(20)
            .padding(10)
            .text('Item 1 with 20px margin')
        )
        .add(
          stack()
            .margin(20)
            .padding(10)
            .text('Item 2 with 20px margin')
        )
        .add(
          stack()
            .margin(20)
            .padding(10)
            .text('Item 3 with 20px margin')
        )
    )
    .spacer(30)
