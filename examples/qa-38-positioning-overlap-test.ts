...
async function main() {
  ...
  const layout = stack()
    ...
    .text('TEST 1: Intentional overlap - 3 elements at similar coords', { bold: true, underline: true })
    .add(
      stack()
        .height(120)
        .add(
          stack()
            .absolutePosition(300, 200)
            .text('[First at 300,200]', { bold: true })
        )
        .add(
          stack()
            .absolutePosition(310, 210)
            .text('[Second at 310,210]')
        )
        .add(
          stack()
            .absolutePosition(320, 220)
            .text('[Third at 320,220]', { italic: true })
        )
    )
    .spacer(15)
      ...
      flex()
        ...
        .add(
          stack()
            ...
            .add(
              stack()
                .absolutePosition(200, 550)
                .text('[Absolute: 200,550]')
            )
        )
        .add(
          stack()
            ...
            .add(
              stack()
                .absolutePosition(1000, 550)
                .text('[Absolute: 1000,550]')
            )
        )
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .add(
          stack()
            .absolutePosition(0, 750)
            .text('[Origin-ish: 0,750]')
        )
        .add(
          stack()
            .absolutePosition(4500, 750)
            .text('[Far right: 4500,750]')
        )
    )
    .spacer(15)
