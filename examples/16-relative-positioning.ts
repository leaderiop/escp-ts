  ...
  const layout = stack()
    ...
    .add(
      stack()
        ...
        .text('-> This text is offset 50 dots to the right')
    )
    ...
    .add(
      stack()
        ...
        .text('Offset UP by 20 dots (overlapping above)')
    )
    ...
    .add(
      stack()
        .relativePosition(80, 10)
        .text('Offset: X+80, Y+10')
    )
