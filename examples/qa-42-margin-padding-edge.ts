  ...
  const layout = stack()
    ...
    .add(
      stack()
        ...
        .margin('auto')
        .padding(10)
        .text('Auto margin centers this box')
    )
    .add(
      stack()
        .width(600)
        .margin('auto')
        .padding(10)
        .text('Wider box also centered with auto margin')
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .add(stack().width(400).padding(10).margin({ bottom: 30 }).text('Item 1: margin-bottom: 30'))
        .add(stack().width(400).padding(10).margin({ top: 20, bottom: 10 }).text('Item 2: margin-top: 20, bottom: 10'))
