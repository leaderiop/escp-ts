...
async function main() {
  ...
  const layout = stack()
      ...
      stack()
        ...
        .add(
          stack()
            .margin(100)
            .padding(10)
            .text("Content with 100px margin")
        )
      ...
      stack()
        .add(
          stack()
            ...
            .margin("auto")
            .padding(10)
            .text("300px wide, centered via margin auto")
        )
    )
    .spacer(10)
    ...
    .add(
      stack()
        ...
        .add(
          stack()
            .margin({ bottom: 40 })
            .text("Box with 40px bottom margin")
        )
        .add(
          stack()
            .margin({ top: 40 })
            .text("Box with 40px top margin")
        )
    )
    .spacer(10)
          ...
          stack()
            ...
            .add(
              stack()
                .margin(10)
                .padding(5)
                .text("Inner: margin(10) padding(5)")
            )
        )
    )
    .spacer(10)
    ...
    .add(
      stack()
        .padding(50)
        .text("Content with 50px padding all around")
        .text("Second line")
    )
    .spacer(10)
