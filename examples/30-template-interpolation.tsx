...
import { Stack, Flex, Text, Line, Spacer, Template } from '../src/jsx';
...
async function main() {
  ...
  const layout = (
    <Stack style={{ gap: 10, padding: 30 }}>
      {/* Header */}
      <Text style={{ bold: true, doubleWidth: true }} align="center">TEMPLATE INTERPOLATION DEMO</Text>
      ...
      <Template template="IMPORTANT: {{company.name | uppercase}}" style={{ bold: true, doubleWidth: true }} />
      <Spacer style={{ height: 15 }} />
  ...
  await renderPreview(commands, 'Template String Interpolation (JSX)', '30-template-interpolation-jsx');
}
