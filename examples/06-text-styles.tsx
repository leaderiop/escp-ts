...
async function main() {
  ...
  const layout = (
    <Stack style={{ gap: 15, padding: 30 }}>
      {/* Title */}
      <Text style={{ bold: true, doubleWidth: true }} align="center">TEXT STYLES SHOWCASE</Text>
      ...
      <Text style={{ italic: true }}>Italic text - The quick brown fox jumps over the lazy dog</Text>
      <Text style={{ underline: true }}>Underlined text - The quick brown fox jumps over the lazy dog</Text>
      ...
      <Text style={{ bold: true, italic: true, underline: true }}>Bold + Italic + Underline (all three)</Text>
      ...
      {/* Footer */}
      <Line char="-" length="fill" />
      <Text style={{ italic: true }} align="center">End of Text Styles Demo</Text>
    </Stack>
  ) as LayoutNode;
