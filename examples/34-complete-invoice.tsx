...
import { LayoutEngine, gt, eq } from '../src/index';
import { Stack, Flex, Text, Line, Spacer, Template, If, Switch, Case, For } from '../src/jsx';
...
async function main() {
  ...
  const invoice = (
    <Stack style={{ padding: 20 }}>
      {/* === HEADER === */}
      <Text style={{ bold: true, doubleWidth: true }} align="center">ACME CORPORATION</Text>
      ...
      <Flex style={{ gap: 10 }}>
        ...
        <Stack style={{ width: 120 }}>
          <Text style={{ bold: true }} align="right">Price</Text>
        </Stack>
        <Stack style={{ width: 120 }}>
          <Text style={{ bold: true }} align="right">Total</Text>
        </Stack>
      </Flex>
      <Line char="-" length="fill" />
      ...
      >
        <Flex>
          ...
          <Stack style={{ width: 120 }}>
            <Template template={'-{{totals.discount.amount | currency:"$"}}'} style={{ italic: true }} align="right" />
          </Stack>
        </Flex>
      </If>
      ...
      <Flex>
        ...
        <If
          condition={gt('totals.shipping.cost', 0)}
            ...
            <Stack style={{ width: 120 }}>
              <Text style={{ bold: true }} align="right">FREE</Text>
            </Stack> as LayoutNode
          }
        >
          <Stack style={{ width: 120 }}>
      ...
      <Flex>
        ...
        <Stack style={{ width: 120 }}>
          <Template template={'{{totals.grandTotal | currency:"$"}}'} style={{ bold: true }} align="right" />
        </Stack>
      </Flex>
