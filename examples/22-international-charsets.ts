...
async function main() {
  ...
  const layout = stack()
    ...
    .text(
      "Each set maps specific ASCII codes to locale-appropriate characters."
    )
  ...
  engine
    .setBold(true)
    .println("PRACTICAL EXAMPLE: MULTI-LANGUAGE HEADERS")
    .setBold(false);
  engine.println("");
  ...
  await renderPreview(
    commands,
    "International Character Sets Demo",
    "22-international-charsets"
  );
}
