...
export function createElement(
  ...
  const rawChildren = resolvedProps.children !== undefined ? [resolvedProps.children] : children;
...
function createLayoutNode(style: NodeStyle, children: LayoutNode[]): StackNode {
...
function createFlexNode(style: NodeStyle, children: LayoutNode[]): FlexNode {
  const node: FlexNode = {
    type: 'flex',
    children,
  };
...
function createSpacerNode(style: NodeStyle, props: Record<string, unknown>): SpacerNode {
...
function createLineNode(style: NodeStyle, props: Record<string, unknown>): LineNode {
  const node: LineNode = {
    type: 'line',
...
function createTemplateNode(style: NodeStyle, props: Record<string, unknown>): TemplateNode {
...
function createCaseMarker(props: Record<string, unknown>, children: LayoutNode[]): CaseMarker {
  return {
    type: 'spacer',
    width: 0,
    height: 0,
...
function createSwitchNode(props: Record<string, unknown>, children: LayoutNode[]): SwitchNode {
