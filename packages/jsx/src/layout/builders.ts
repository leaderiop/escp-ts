...
export class StackBuilder {
  ...
  fallback(node: LayoutNode | StackBuilder | FlexBuilder): this {
    this.node.fallback =
      node instanceof StackBuilder || node instanceof FlexBuilder ? node.build() : node;
    return this;
  }
  ...
  line(char = '-', length?: number | 'fill'): this {
  ...
  add(child: LayoutNode | StackBuilder | FlexBuilder | GridBuilder): this {
    if (
      child instanceof StackBuilder ||
      child instanceof FlexBuilder ||
      child instanceof GridBuilder
    ) {
 ...
 * ```
 */
export function line(char = '-', length?: number | 'fill'): LineNode {
  return {
    type: 'line',
    direction: 'horizontal',
    char,
...
export class ConditionalBuilder {
  ...
  elseIf(
    ...
    this.node.elseIf.push({
      condition,
      then:
        thenNode instanceof StackBuilder || thenNode instanceof FlexBuilder
          ? thenNode.build()
          : thenNode,
    });
    return this;
...
export class SwitchBuilder {
  ...
  /** Add a case branch */
  case(value: unknown | unknown[], thenNode: LayoutNode | StackBuilder | FlexBuilder): this {
...
export class EachBuilder {
  ...
  render(node: LayoutNode | StackBuilder | FlexBuilder | TemplateBuilder): this {
    this.node.render =
      node instanceof StackBuilder || node instanceof FlexBuilder || node instanceof TemplateBuilder
        ? node.build()
        : node;
    return this;
  }
