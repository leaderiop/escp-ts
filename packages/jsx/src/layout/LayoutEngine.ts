...
import { type StackBuilder, type FlexBuilder, stack, flex } from './builders';
...
export class LayoutEngine {
   ...
   */
  setScalableFont(pointSize: number, pitch = 0): this {
   ...
   */
  printImage(image: GrayscaleImage, options: Partial<ConversionOptions> = {}): this {
    const state = this.stateManager.getState();
