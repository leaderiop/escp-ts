...
import { getGridBorderCharSet } from '@escp/core';
...
describe('Border Alignment', () => {
  describe('Vertical Border Alignment with Junctions', () => {
    ...
    it('should have row separator junctions at same X position as vertical borders', () => {
      ...
      const cells = [
        Stack({
          style: { flexGrow: 33, flexShrink: 1, flexBasis: 0 },
        ...
        Stack({
          style: { flexGrow: 34, flexShrink: 1, flexBasis: 0 },
  ...
  describe('Border Character TEXT Position Within Container', () => {
    it('should have Text node at same relative X within border containers', () => {
      ...
      console.log('Top-left corner container:', {
        x: topLeftCornerContainer.x,
        width: topLeftCornerContainer.width,
      });
      console.log('Left vertical container:', {
        x: leftVerticalContainer.x,
        width: leftVerticalContainer.width,
      });
    ...
    it('should have junction and vertical text at same X in middle border position', () => {
      ...
      const cells = [
        Stack({
          style: { flexGrow: 50, flexShrink: 1, flexBasis: 0 },
          children: Text({ children: 'Col1' }),
        }),
        Stack({
          style: { flexGrow: 50, flexShrink: 1, flexBasis: 0 },
          children: Text({ children: 'Col2' }),
        }),
      ];
      const contentRow = wrapCellsWithVerticalBorders(cells, chars) as LayoutNode;
      ...
      console.log('Middle junction (┬) container:', {
        x: middleJunctionContainer.x,
        width: middleJunctionContainer.width,
      });
      console.log('Middle vertical (│) container:', {
        x: middleVerticalContainer.x,
        width: middleVerticalContainer.width,
      });
