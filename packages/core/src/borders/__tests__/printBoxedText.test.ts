...
import { printBoxedText, printSimpleBox, printDoubleBox } from '../printBoxedText';
...
describe('printBoxedText', () => {
  describe('selectRenderMode', () => {
    ...
    it('should return graphics mode when explicitly requested', () => {
      ...
      expect(selectRenderMode('graphics', CHAR_TABLE.ISO_LATIN_1 as CharacterTable)).toBe(
        'graphics'
      );
    });
  });
  ...
  describe('printBoxedText output', () => {
    ...
    it('should handle multi-line text', () => {
      const result = printBoxedText(
        ['Line 1', 'Line 2', 'Line 3'],
        CHAR_TABLE.PC437_USA as CharacterTable
      );
      expect(result).toBeInstanceOf(Uint8Array);
    ...
    it('should respect padding option', () => {
      const withPadding = printBoxedText('X', CHAR_TABLE.PC437_USA as CharacterTable, {
        padding: 5,
      });
    ...
    it('should respect borderStyle option', () => {
      const single = printBoxedText('X', CHAR_TABLE.PC437_USA as CharacterTable, {
        borderStyle: 'single',
      });
      const double = printBoxedText('X', CHAR_TABLE.PC437_USA as CharacterTable, {
        borderStyle: 'double',
      });
    ...
    it('should use ASCII chars for ascii borderStyle', () => {
      const result = printBoxedText('X', CHAR_TABLE.PC437_USA as CharacterTable, {
        borderStyle: 'ascii',
      });
      const resultArray = Array.from(result);
