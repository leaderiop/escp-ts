...
async function main() {
  ...
  const layout = stack()
    ...
    // Title
    .text('ROW STACK VERTICAL ALIGNMENT STRESS TEST', {
      bold: true,
      doubleWidth: true,
      align: 'center',
    })
    ...
    .text('TEST 1: vAlign comparison - same children, different alignment', {
      bold: true,
      underline: true,
    })
    .text('TOP alignment:')
    ...
    .add(
      stack()
        ...
        .vAlign('center')
        .gap(30)
        .add(stack().width(300).padding(10).text('One line'))
        .add(stack().width(300).padding(10).text('Two lines').text('of text'))
        .add(
          stack()
            .width(300)
            .padding(10)
    ...
    .add(
      stack()
        ...
        .add(stack().width(200).padding(80).text('Very tall').text('with lots').text('of padding'))
        .add(stack().width(200).padding(5).text('Tiny'))
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .vAlign('center')
        .gap(20)
        .add(stack().width(350).direction('column').gap(5).text('Nested stack A').text('Line 2'))
        .add(
          stack()
            .width(350)
            .direction('column')
        ...
        .add(stack().width(350).direction('column').gap(5).text('Nested stack C'))
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .height(100)
        .add(
          stack().width(400).padding(10).text('Single child in center of 100px height container')
        )
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .add(stack().width(300).padding(20).text('Container').text('with padding'))
