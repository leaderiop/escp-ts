...
import { Stack, Flex, Text, Spacer, Line } from '@escp/jsx';
...
const TableRow: FunctionComponent<TableRowProps> = ({ qty, desc, price, total, bold: isBold }) => (
  <Flex style={{ gap: 20 }}>
...
async function main() {
  ...
  await renderPreview(commands, 'Layout System Demo (JSX)', '02-layout-system-jsx');
}
