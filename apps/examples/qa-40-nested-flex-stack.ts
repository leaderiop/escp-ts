...
async function main() {
  ...
  const layout = stack()
    ...
    // Title
    .text('DEEPLY NESTED FLEX/STACK STRESS TEST', {
      bold: true,
      doubleWidth: true,
      align: 'center',
    })
          ...
          stack() // Level 2: Stack
            ...
            .add(
              flex() // Level 3: Flex
                ...
                .add(stack().width(150).padding(5).text('L4-2'))
            )
        )
        .add(
          stack() // Level 2: Stack
            ...
            .add(
              flex() // Level 3: Flex
                ...
                .add(stack().width(150).padding(5).text('L4-4'))
            )
        )
    )
    .spacer(15)
      ...
      stack()
        ...
        .add(
          stack()
            ...
            .add(stack().width('60%').padding(10).text('[60% of parent = 33.6% total]'))
        )
    )
    .spacer(15)
