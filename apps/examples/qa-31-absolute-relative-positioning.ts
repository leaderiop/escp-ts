...
async function main() {
  ...
  const layout = stack()
    ...
    .add(
      stack()
        .height(150)
        .add(stack().absolutePosition(300, 100).text('[Pos: 300,100]'))
        .add(stack().absolutePosition(800, 120).text('[Pos: 800,120]'))
        .add(stack().absolutePosition(1500, 140).text('[Pos: 1500,140]'))
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .add(stack().relativePosition(100, 0).text('[Offset X: +100]'))
        .add(stack().relativePosition(200, 0).text('[Offset X: +200]'))
        .add(stack().relativePosition(0, -20).text('[Offset Y: -20]'))
    )
    .spacer(15)
    ...
    .add(
      flex()
        ...
        .add(stack().absolutePosition(1000, 450).text('[Absolute at 1000,450]'))
    ...
    .add(
      stack()
        .height(120)
        .add(stack().absolutePosition(400, 580).text('[First: 400,580]', { bold: true }))
        .add(stack().absolutePosition(420, 600).text('[Second: 420,600]'))
        .add(stack().absolutePosition(440, 620).text('[Third: 440,620]', { italic: true }))
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .add(stack().relativePosition(-50, 0).text('[Shifted left by 50]'))
        .add(stack().relativePosition(50, 0).text('[Shifted right by 50]'))
    )
    .spacer(15)
    ...
    .add(
      stack()
        .height(100)
        .add(stack().absolutePosition(250, 1000).text('[Near left edge: 250]'))
        .add(stack().absolutePosition(4000, 1020).text('[Far right: 4000]'))
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .add(stack().relativePosition(30, 0).text('[Relative +30x]'))
        .add(stack().text('[Static - normal flow]'))
        .add(stack().absolutePosition(1800, 1150).text('[Absolute 1800,1150]'))
        .add(stack().text('[Static - normal flow]'))
    )
    .spacer(15)
    ...
    .add(stack().height(60).add(stack().absolutePosition(0, 1350).text('[Absolute at 0,Y]')))
    .spacer(15)
  ...
  await renderPreview(
    commands,
    'QA: Absolute/Relative Positioning',
    'qa-31-absolute-relative-positioning'
  );
}
