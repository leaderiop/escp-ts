...
async function main() {
  ...
  const layout = stack()
    ...
    .add(stack().absolutePosition(100, 1700).text('Abs (100, 1700)', { bold: true }))
    .add(stack().absolutePosition(500, 1700).text('Abs (500, 1700)', { bold: true }))
    .add(stack().absolutePosition(900, 1700).text('Abs (900, 1700)', { bold: true }))

    // Diagonal pattern starting at Y=1800
    .add(stack().absolutePosition(150, 1800).text('Diagonal 1'))
    .add(stack().absolutePosition(400, 1880).text('Diagonal 2'))
    .add(stack().absolutePosition(650, 1960).text('Diagonal 3'))
