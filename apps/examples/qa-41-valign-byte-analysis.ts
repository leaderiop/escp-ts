...
async function main() {
  ...
  const layout = stack()
    ...
    // ============================================================
    .text('TEST 4: Explicit heights [50, 100, 50] with vAlign=center', {
      bold: true,
      underline: true,
    })
    .add(
    ...
    .add(
      stack()
        ...
        .vAlign('center')
        .gap(30)
        .add(stack().width(250).padding(5).text('One line'))
        .add(
          stack().width(250).padding(5).text('Line 1').text('Line 2').text('Line 3').text('Line 4')
        )
        .add(stack().width(250).padding(5).text('One line'))
    )
