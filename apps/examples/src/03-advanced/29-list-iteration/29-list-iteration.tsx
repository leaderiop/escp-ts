...
import { LayoutEngine, gt } from '@escp/jsx';
import { Stack, Flex, Text, Line, Spacer, Template, If, For } from '@escp/jsx';
...
async function main() {
  ...
  const layout = (
    <Stack style={{ gap: 10, padding: 30 }}>
      ...
      <For items="products" as="p" separator={(<Line char="." length="fill" />) as LayoutNode}>
        <Stack>
