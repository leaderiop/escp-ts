  ...
  const layout = stack()
    ...
    .add(
      stack()
        ...
        .add(
          stack().width(300).padding(30).text('Tall element with lots of padding making it taller')
        )
    )
    .spacer(15)
    ...
    .add(
      stack()
        ...
        .vAlign('center')
        .gap(30)
        .add(stack().width(400).gap(5).text('Multi-line').text('content').text('here'))
        .add(stack().width(400).text('Single line'))
        .add(
          stack().width(400).gap(5).text('Another').text('multi-line').text('block').text('of text')
        )
    )
    .spacer(15)
