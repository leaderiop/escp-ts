  ...
  const layout = stack()
    ...
    .add(
      stack()
        ...
        .add(stack().absolutePosition(0, 0).text('[ABS 0,0]'))
    ...
    .add(
      stack()
        ...
        .add(stack().absolutePosition(50, 300).text('[ABS 50,300]'))
        .add(stack().absolutePosition(400, 300).text('[ABS 400,300]'))
        .add(stack().absolutePosition(750, 300).text('[ABS 750,300]'))
    ...
    .add(
      stack()
        .gap(5)
        .text('Normal: Line 1')
        .add(stack().relativePosition(50, 0).text('Relative offset X:50 Y:0'))
    ...
    .add(
      stack()
        ...
        .add(stack().relativePosition(-30, -10).text('Relative X:-30 Y:-10'))
      ...
      stack()
        ...
        .add(
          stack()
            ...
            .add(stack().absolutePosition(100, 550).text('[ABS from nested: 100,550]'))
    ...
    .add(
      stack()
        ...
        .text('Line A')
        .text('Line B')
        .add(stack().absolutePosition(600, 700).text('[ABS Element]'))
    ...
    .add(
      flex()
        .gap(30)
        .text('Normal')
        .add(stack().relativePosition(0, -15).text('Rel Y:-15'))
        .text('Normal')
        .add(stack().relativePosition(0, 15).text('Rel Y:15'))
        .text('Normal')
    )
    ...
    .add(
      stack()
        ...
        .add(stack().absolutePosition(200, 850).text('FIRST ABSOLUTE TEXT'))
        .add(stack().absolutePosition(200, 850).text('SECOND (OVERLAPS)'))
    )
    .spacer(100)
