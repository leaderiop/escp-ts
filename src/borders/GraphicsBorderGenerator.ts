 ...
 */
export function createHorizontalLineBitmap(widthDots: number, thickness: number = 1): GrayscaleImage {
 ...
 */
export function createVerticalLineBitmap(heightDots: number, thickness: number = 1): GrayscaleImage {
 ...
 */
export function createCornerBitmap(
  corner: CornerType,
  size: number = 6,
  thickness: number = 1
): GrayscaleImage {
 ...
 */
export function createBorderCorner(corner: CornerType, size: number = 6): BitImageData {
