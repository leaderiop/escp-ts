...
describe('CommandBuilder', () => {
  ...
  describe('Print Position', () => {
    ...
    it('absoluteHorizontalPosition max value (65535)', () => {
      ...
      expect(result).toEqual(new Uint8Array([ASCII.ESC, ESC_COMMANDS.ABSOLUTE_HORZ_POS, 0xff, 0xff]));
    });
  ...
  describe('Page Format', () => {
    ...
    it('setPageLengthInches() sets page length in inches', () => {
      ...
      expect(result).toEqual(new Uint8Array([ASCII.ESC, ESC_COMMANDS.PAGE_LENGTH_LINES, ASCII.NUL, 11]));
    });
  ...
  describe('Font Selection', () => {
    it('selectPica() returns ESC P (10 CPI)', () => {
      expect(CommandBuilder.selectPica()).toEqual(
        new Uint8Array([ASCII.ESC, ESC_COMMANDS.PICA])
      );
    });

    it('selectElite() returns ESC M (12 CPI)', () => {
      expect(CommandBuilder.selectElite()).toEqual(
        new Uint8Array([ASCII.ESC, ESC_COMMANDS.ELITE])
      );
    });
  ...
  describe('Font Style', () => {
    it('boldOn() returns ESC E', () => {
      expect(CommandBuilder.boldOn()).toEqual(
        new Uint8Array([ASCII.ESC, ESC_COMMANDS.BOLD_ON])
      );
    });

    it('boldOff() returns ESC F', () => {
      expect(CommandBuilder.boldOff()).toEqual(
        new Uint8Array([ASCII.ESC, ESC_COMMANDS.BOLD_OFF])
      );
    });
  ...
  describe('user-defined characters', () => {
    ...
    it('defineUserChars() defines custom characters', () => {
      const charData = [
        { proportional: 24, data: new Uint8Array([0x00, 0x7e, 0x42, 0x7e, 0x00]) },
      ];
